...
var SIGNED_URL = 'https://m7cgx2oef7.execute-api.us-east-1.amazonaws.com/dev/hello';
axios_1["default"].post(SIGNED_URL).then(function (resp) {
    ...
    Object.keys(fields).forEach(function (key) { return console.log(key.toLocaleLowerCase()); });
    Object.keys(fields).forEach(function (key) { formData.append(key, fields[key]); });
    var file = fs.readFileSync('/Users/jgreenf/Desktop/bill.png');
